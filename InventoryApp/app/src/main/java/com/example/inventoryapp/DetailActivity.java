...
//                startActivity(intent);
        ...
        searchView.setOnQueryTextListener(DetailActivity.this);
    ...
    private void fetchData(String index) {
       LoadMoreAyscTask task=new LoadMoreAyscTask(DetailActivity.this,Integer.valueOf(index));
        task.execute();
    }
...
//
        ...
        private void setDataAdapter(ArrayList<POModel> arrayList) {
            adapter=new ItemAdapter(context,arrayList);
