...
import com.example.inventoryapp.Interface.OnBottomReachedListener;
...
public class RecieveDetail extends AppCompatActivity implements SearchView.OnQueryTextListener ,SalesAdapter.ContactsAdapterListener {
   ...
   static int counter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(RecieveDetail.this);
    ...
    private void fetchData(String index) {
        LoadMoreAyscTask task=new LoadMoreAyscTask(RecieveDetail.this,Integer.valueOf(index));
        task.execute();
    }
...
//            txtVuLaoding.setVisibility(View.VISIBLE);
        ...
        private void setDataAdapter(ArrayList<SalesModel> arrayList) {
                if(String.valueOf(arrayList.size())!=null){
                    ...
                    adapter=new SalesAdapter(context,arrayList);
