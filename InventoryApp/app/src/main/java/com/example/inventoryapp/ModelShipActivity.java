...
import com.example.inventoryapp.Fragments.ModelShipScanFragment;
import com.example.inventoryapp.Fragments.ScanFragment;

public class ModelShipActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_ship);
        ...
        ModelShipScanFragment scanFragment = new ModelShipScanFragment();
    ...
    private void setUpPersission() {
        ActivityCompat.requestPermissions(ModelShipActivity.this,
    ...
    private void message() {
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(ModelShipActivity.this,"Please allow the following Permissions ", Toast.LENGTH_LONG).show();
                ModelShipActivity.this.finish();
            }
        });
